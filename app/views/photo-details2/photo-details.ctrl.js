(function () {
    ...
    angular
        .module('app')
        .controller('PhotoDetailsCtrl2', PhotoDetailsCtrl2);

	PhotoDetailsCtrl2.$inject = ['$scope', '$log', '$window', '$rootScope', 'dictionary', 'apiService', 'CONST'];

    /* @ngInject */
    function PhotoDetailsCtrl2($scope, $log, $window, $rootScope, dictionary, apiService, CONST) {
        var vm = this;
        vm.dict = dictionary();
